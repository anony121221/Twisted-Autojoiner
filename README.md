...
2. Run the script:
   ...
   ```
3. Read the Setup Instructions on first launch.
4. Press **Start** to begin the auto-join process.
5. Press **Stop** to end it.
6. Close the window to save its position and exit.
